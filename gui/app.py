...
class MainWindow(QMainWindow):
    ...
    def _build_about_tab(self) -> QWidget:
        ...
        info = QLabel(
            ...
            "Só saem do programa três serviços, todos de LEITURA: 0x01 (OBD-II\n"
            "modo 01), 0x09 (informações do veículo, incl. chassi) e 0x22 (UDS\n"
            "Read Data By Identifier). Uma lista branca no\n"
            ...
            "  • Consulta do chassi (VIN) por OBD-II modo 09 e por UDS 0xF190\n"
